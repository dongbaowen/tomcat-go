...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        /**
         * step 3：为Server添加生命周期监听器
         *
         * ps：Server会被默认设置5个监听器
         * 1、AprLifeCycleListener：在Server初始化之前加载APR库，并于Server停止后销毁
         * 2、VersionLoggerListener：在Server初始化之前打印操作系统，JVM以及服务器版本信息
         * 3、JreMemoryLeakPreventionListener：在Server初始化之前调用，以解决单例对象创建导致的JVM内存泄漏问题以及锁文件问题
         * 4、GlobalResourcesLifecycleListener：在Server启动时，将JNDI资源注册为MBean进行管理
         * 5、ThreadLocalLeakPreventionListener：用于在Context停止时重建Executor池中的线程，避免导致内存泄漏
         */
         ...
         * step 4：构造Service实例
         *
         * Catalina默认Service的实现类为org.apache.catalina.core.StandardService.同时
         * 我们也可以通过className 设置自己的实现类，创建完成后，通过addService方法添加到Server中.
         */
        ...
        /**
         * step 5：为Service添加生命周期监听器
         *
         * 默认情况下，Catalina未指定Service监听器.
         */
        ...
        /**
         * step 6：为Service添加Executor
         *
         * 默认为{@link StandardThreadExecutor}
         */
        //Executor
